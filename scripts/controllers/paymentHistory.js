...
angular
  .module('urbanApp')
  .controller('paymentHistCtrl', ['$scope', '$location', '$http', '$state', 'UserService', 'DTOptionsBuilder', '$rootScope', '$timeout',  paymentHistCtrl]);
	function paymentHistCtrl($scope, $location, $http, $state, UserService, DTOptionsBuilder, $rootScope, $timeout) {
  ...
  $scope.filterTransactions = function(obj = document.getElementById("fltrBtn")){
    ...
    var organization = $('#providers').find(":selected").val();
    var type = $('#status').find(":selected").val();
    ...
    var  url= UserService.apiRoot+'hmo/get/payment-history/'+fromDate+'/'+toDate+'/'+organization+'/'+type;
